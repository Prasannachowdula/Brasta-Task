...
const Menu2 = ({ menu, title, image }) => {
  return (
    <div className='w-full flex flex-col lg:flex-row justify-between px-6 lg:px-12 py-10 gap-6'>

      <div className='w-full lg:w-[65%] flex flex-col items-center lg:pl-16'>
